...
export default function Profile({ vendor, products, departments, filters }: ProfileProps) {
  ...
  const handleFilterChange = () => {
    router.get(route("vendor.profile", { vendor: vendor.store_name }), {
  ...
  return (
    <AuthenticatedLayout>
      ...
      <div className="bg-gray-200 py-10 text-center">
        <h1 className="text-3xl font-semibold text-gray-800">{vendor.store_name}</h1>
      </div>
